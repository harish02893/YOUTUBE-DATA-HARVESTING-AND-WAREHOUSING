...
def Api_connect():
    Api_Id="AIzaSyCvu_PW7VnF-VOdAbSRjAnN7kBFOu9wdas"
    ...
    for video_id in video_ids:
        ...
        for item in response["items"]:
            data=dict(
                ...
                Title=item['snippet']['title'],
                Tags=item.get('tags'),
                Thumbnail=item['snippet']['thumbnails']['default']['url'],  # Assuming you want the default thumbnail URL
...
with st.sidebar:
    ...
    st.header("By Kesavan sekar (DT1819 Batch)")
...
if question == '3. 10 most viewed videos':
    query3 = '''select Views as views , Videoname as Video_Tiltle,Columns as Video_Title from videos 
    ...
    query6 = '''SELECT Likes as likeCount, VideoTitle FROM videos;'''
